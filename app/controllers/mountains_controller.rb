class MountainsController < ApplicationController
  ...
  def destroy
    ...
    respond_to do |format|
      format.html { redirect_to mountains_path, status: :see_other, notice: "Mountain was successfully destroyed." }
  ...
  private
    ...
    def set_mountain
      @mountain = Mountain.find(params.expect(:id))
    end

    # Only allow a list of trusted parameters through.
    def mountain_params
      params.expect(mountain: [ :name ])
    end
end
